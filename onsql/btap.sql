...
CREATE TABLE IF NOT EXISTS phim(
    ...
    trailer VARCHAR,
    mo_ta TEXT,
    FOREIGN KEY dao_dien_id REFERENCES user (id),
...
INSERT INTO user (id, ten_nguoi_dung,mat_khau,ho_ten,sdt,quyen_id,ngay_sinh) VALUES
(1,'nguyenvanan','123456','Nguyễn Văn An','0911000001',1,'1999-02-01'),
(2,'tranthibich','123456','Trần Thị Bích','0911000002',2,'2000-03-12'),
(3,'phamvanhoa','123456','Phạm Văn Hoa','0911000003',3,'1998-07-20'),
(4,'lethutrang','123456','Lê Thu Trang','0911000004',4,'2001-11-05'),
(5,'dangquocduy','123456','Đặng Quốc Duy','0911000005',5,'1997-09-15'),
(6,'hoangminhtam','123456','Hoàng Minh Tâm','0911000006',6,'1999-01-10'),
(7,'ngothanhtuan','123456','Ngô Thanh Tuấn','0911000007',7,'1996-12-24'),
(8,'vuthihong','123456','Vũ Thị Hồng','0911000008',8,'2002-04-02'),
(9,'truongtienphat','123456','Trương Tiến Phát','0911000009',9,'1998-06-09'),
(10,'dangthimai','123456','Đặng Thị Mai','0911000010',10,'2001-02-14'),
(11,'phungvanan','123456','Phùng Văn An','0911000011',11,'1999-08-03'),
(12,'hoangthoa','123456','Hoàng Thảo','0911000012',12,'2000-10-21'),
(13,'nguyenthien','123456','Nguyễn Thiện','0911000013',13,'1997-01-19'),
(14,'dangkimanh','123456','Đặng Kim Anh','0911000014',14,'1998-03-30'),
(15,'caominhtri','123456','Cao Minh Trí','0911000015',15,'1999-09-28'),
(16,'lamtuananh','123456','Lâm Tuấn Anh','0911000016',16,'2000-12-01'),
(17,'nguyenthaonhi','123456','Nguyễn Thảo Nhi','0911000017',17,'2002-07-07'),
(18,'hoangduccanh','123456','Hoàng Đức Cảnh','0911000018',18,'1996-11-11'),
(19,'buitranquynh','123456','Bùi Trần Quỳnh','0911000019',19,'2000-04-19'),
(20,'phamngocnam','123456','Phạm Ngọc Nam','0911000020',20,'1998-10-10'),
(21,'luuthithu','123456','Lưu Thị Thu','0911000021',21,'2001-03-03'),
(22,'ngocminhquan','123456','Ngọc Minh Quân','0911000022',22,'1997-06-16'),
(23,'vuducthang','123456','Vũ Đức Thắng','0911000023',23,'1999-09-09'),
(24,'phamhoanglam','123456','Phạm Hoàng Lâm','0911000024',24,'1996-05-25'),
(25,'hoangthuminh','123456','Hoàng Thu Minh','0911000025',25,'2002-08-08'),
(26,'truongvanbinh','123456','Trương Văn Bình','0911000026',26,'1995-12-12'),
(27,'nguyenthutrang','123456','Nguyễn Thu Trang','0911000027',27,'1999-03-22'),
(28,'duongquocviet','123456','Dương Quốc Việt','0911000028',28,'1998-01-29'),
(29,'nguyenminhthao','123456','Nguyễn Minh Thảo','0911000029',29,'2001-06-06'),
(30,'lequanghuy','123456','Lê Quang Huy','0911000030',30,'1997-02-17');

INSERT INTO quoc_gia(id, ten_quoc_gia)
...
INSERT INTO phim(id, ten_phim, dao_dien_id, the_loai_id, nam_phat_hanh,poster, quoc_gia_id, so_tap, trailer, mo_ta) VALUES
...
INSERT INTO tap_phim(id, phim_id, so_tap, tieu_de, trailer) VALUES
